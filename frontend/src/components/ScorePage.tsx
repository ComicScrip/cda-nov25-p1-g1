...
export default function ScorePage({ 
  ...
  return (
    <div 
      className="h-[100dvh] w-full bg-cover bg-center bg-no-repeat relative flex items-center justify-center font-sans p-2 overflow-hidden"
      ...
      <div className="relative z-10 w-full max-w-[95vw] h-full flex flex-col items-center justify-around py-4">
        ...
        <div className="flex flex-row w-full justify-center items-center gap-2 sm:gap-4 md:gap-10">
          ...
          <div className="relative w-[40%] max-w-[300px] aspect-[3/4] flex items-center justify-center">
            <img src="/parchemin.png" className="absolute inset-0 w-full h-full object-contain" alt="Score" />
          ...
          <div className="w-[15%] max-w-[120px] flex justify-center items-center">
             <img src="/pharaon-enfant.png" className="w-full h-auto drop-shadow-2xl" alt="Pharaon" />
          </div>

          {/* PARCHEMIN DROITE */}
          <div className="relative w-[40%] max-w-[300px] aspect-[3/4] flex items-center justify-center">
            <img src="/parchemin.png" className="absolute inset-0 w-full h-full object-contain" alt="Record" />
            <div className="relative z-10 text-center flex flex-col justify-center items-center h-full w-full px-2 pt-4">
              <h2 className="text-[#5d3a1a] text-[3vw] sm:text-lg md:text-2xl font-black uppercase leading-tight">
                Meilleur score
              </h2>
