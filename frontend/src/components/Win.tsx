...
export default function Win({ word, score, onRejouer, onComplete }: WinProps) {
  ...
  useEffect(() => {
    // On attend 2 secondes avant de valider la complétion
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col items-center justify-center bg-[url('/Win.png')] bg-cover bg-center bg-no-repeat p-2 sm:p-4 overflow-hidden">
      
      {/* Overlay léger pour garantir la lecture sur n'importe quelle image de fond */}
      <div className="absolute inset-0 bg-black/20 pointer-events-none" />

      <div className="relative z-10 flex flex-col items-center w-full max-w-4xl py-2 sm:py-6 h-full justify-around">
        
        {/* 1. TEXTE DE VICTOIRE & SCORE */}
        <div className="text-center">
          <h2 className="text-[12vw] sm:text-6xl md:text-8xl font-black text-yellow-400 drop-shadow-[0_4px_0px_#8b5a2b] uppercase tracking-tighter leading-none mb-2">
            Bravo !
          </h2>
        ...
        <div className="flex flex-col gap-3 w-full max-w-[280px] sm:max-w-[350px] md:max-w-md">
          {/* Bouton Rejouer */}
          <button 
            onClick={onRejouer} 
